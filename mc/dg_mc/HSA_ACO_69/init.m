% Ëæ»ú²úÉúÒ»¸öÎ´¾­ÐÞ¸´µÄ³õÊ¼½â
% INITÎªÒ»¸ö1*sµÄ¾ØÕó£¬ÒÔ0-1±íÃ÷¸÷¸ö¿ª¹ØµÄ¿ª±Õ×´Ì¬
% duan_kaiÎªÒ»¸ö1*mµÄ¾ØÕó£¬´¢´æ¸÷¸ö»·ÄÚµÄ¶Ï¿ª¿ª¹ØµÄ±àºÅ
%%
...
%% È¡µÚÒ»¸ö»·Â·µÄ¶Ï¿ª¿ª¹Ø
x = length(round1).*rand(1);
y1 = round1(ceil(x));
duan_kai(1) = y1;
INIT(y1) = 0;
%% È¡µÚ¶þ¸ö»·Â·µÄ¶Ï¿ª¿ª¹Ø
judge = 0;
