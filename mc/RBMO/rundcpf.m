function [MVAbase, bus, gen, branch, success, et] = rundcpf(baseMVA, bus, gen, branch, mpopt, fname, solvedcase)
...
[MVAbase, bus, gen, branch, success, et] = runpf(baseMVA, bus, gen, branch, mpopt, fname, solvedcase);
